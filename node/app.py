...
from routes import network_bp, transactions_bp, blockchain_bp, wallet_bp, mining_bp, contract_bp, digital_soul_bp
...
app.register_blueprint(digital_soul_bp, url_prefix='/api/digital-soul')
